...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/aws-checksums-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aws-checksums-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add aws-checksums
# for installing globally
pixi global install aws-checksums
```
...
It is possible to list all of the versions of `aws-checksums` available on your platform:
...
```
pixi search aws-checksums --channel conda-forge
```
